...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/PMCrypto/Crypto.xcframework" "" "false" "ios-x86_64-maccatalyst/Crypto.framework" "ios-i386_x86_64-simulator/Crypto.framework" "ios-armv7_arm64/Crypto.framework"
fi
