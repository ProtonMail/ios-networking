...
install_xcframework "${PODS_ROOT}/PMCrypto/Crypto.xcframework" "Crypto" "framework" "ios-x86_64-maccatalyst/Crypto.framework" "ios-i386_x86_64-simulator/Crypto.framework" "ios-armv7_arm64/Crypto.framework"
