...
public class ProtonButton: UIButton {
    ...
    public override var isHighlighted: Bool { didSet { updateOutline() } }
    public override var isEnabled: Bool { didSet { updateOutline() } }
    ...
    fileprivate func stopLoading() {
        contentEdgeInsets = UIEdgeInsets(top: contentEdgeInsets.top, left: 36, bottom: contentEdgeInsets.bottom, right: 36)
