...
class CountryCodeViewModel {
    ...
    func getPhoneCodeFromName(_ name: String?) -> Int {
    ...
    fileprivate func prepareData(searchText: String = "") {
        ...
        if searchText != "" {
            searchCountryCodes = countryCodes.filter { $0.country_en.range(of: searchText, options: .caseInsensitive) != nil  }
        }
