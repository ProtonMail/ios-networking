...
public class NetworkTroubleShootViewController: UITableViewController, ViewModelProtocol, Coordinated {
    ...
    public func set(viewModel: NetworkTroubleShootViewModel) {
        self.viewModel = viewModel
    }
    
    public func set(coordinator: NetworkTroubleShootCoordinator) {
    ...
    public override func viewDidLoad() {
        ...
        ///TODO::fix the local
        let newBackButton = UIBarButtonItem(title: "back", // LocalString._general_back_action,
    ...
    public override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let cellout = cell as? SwitchTwolineCell {
            if item == .allowSwitch {
                ...
                cellout.configCell(item.top, bottomLine: item.AttrString, showSwitcher: true, status: true /*DoHMail.default.status == .on*/) { cell, newStatus, feedback in
                    if newStatus {
