...
public class NetworkTroubleShootCoordinator : ModalCoordinator {
    lazy public var configuration: ((NetworkTroubleShootViewController) -> ())? = { vc in
    ...
    public typealias VC = NetworkTroubleShootViewController

    weak public var viewController: NetworkTroubleShootViewController?
...
//
    public init(nav: UINavigationController, services: ServiceFactory) {
        self.viewModel = NetworkTroubleShootViewModelImpl()
