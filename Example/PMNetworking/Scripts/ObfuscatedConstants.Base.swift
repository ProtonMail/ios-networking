...
class ObfuscatedConstantsBase {
    ...
    static let salamBlackSignupDomain: String = ""
    static let salamBlackDefaultHost: String = ""
    static let salamBlackCaptchaHost: String = ""
    static let salamBlackApiHost: String = ""
